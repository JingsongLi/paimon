...
import org.apache.paimon.mergetree.compact.separated.SeparatedCompactManagerFactory;
...
public interface KvCompactionManagerFactory extends Closeable {
    ...
    static KvCompactionManagerFactory create(
        ...
        if (options.keyValueSeparated()) {
            return new SeparatedCompactManagerFactory(
                    readerFactoryBuilder, options, keyType, cacheManager);
        }
