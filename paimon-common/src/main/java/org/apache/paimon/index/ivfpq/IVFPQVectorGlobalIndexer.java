...
/** IVF-PQ vector global indexer backed by native Rust implementation. */
public class IVFPQVectorGlobalIndexer implements GlobalIndexer {
    ...
    public IVFPQVectorGlobalIndexer(DataType fieldType, Options options) {
        ...
        this.options = new IVFPQIndexOptions(fieldType, options);
    }
    ...
    public GlobalIndexReader createReader(
        ...
        return new IVFPQVectorGlobalIndexReader(fileReader, files, options, executor);
    }
}
