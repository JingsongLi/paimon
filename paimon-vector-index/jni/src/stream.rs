...
impl SeekRead for JniSeekableStream {
    fn seek(&mut self, pos: u64) -> io::Result<()> {
        ...
        let mut env = self
            ...
            .map_err(|e| io::Error::new(io::ErrorKind::Other, format!("JNI attach: {}", e)))?;
        ...
        .map_err(|e| io::Error::new(io::ErrorKind::Other, format!("JNI seek: {}", e)))?;
    ...
    fn pread(&mut self, pos: u64, buf: &mut [u8]) -> io::Result<()> {
        ...
        let jbuf = env
            ...
            .map_err(|e| io::Error::new(io::ErrorKind::Other, format!("JNI alloc: {}", e)))?;
        ...
        while total_read < length {
            ...
            let n = env
                ...
                .map_err(|e| io::Error::new(io::ErrorKind::Other, format!("JNI pread: {}", e)))?
                .i()
                .map_err(|e| {
                    io::Error::new(io::ErrorKind::Other, format!("JNI pread return: {}", e))
                })?;
        ...
        env.get_byte_array_region(&jbuf, 0, &mut signed_buf)
            .map_err(|e| {
                io::Error::new(io::ErrorKind::Other, format!("JNI get_region: {}", e))
            })?;
...
fn read_bytes_from_stream(jvm: &JavaVM, stream_ref: &GlobalRef, buf: &mut [u8]) -> io::Result<()> {
    ...
    while total_read < length {
        ...
        let n = env
            ...
            .map_err(|e| io::Error::new(io::ErrorKind::Other, format!("JNI read: {}", e)))?
            .i()
            .map_err(|e| {
                io::Error::new(io::ErrorKind::Other, format!("JNI read return: {}", e))
            })?;
...
impl paimon_vindex_core::io::SeekWrite for JniOutputStream {
    fn write_all(&mut self, buf: &[u8]) -> io::Result<()> {
        ...
        env.set_byte_array_region(&jbuf, 0, &signed)
            .map_err(|e| io::Error::new(io::ErrorKind::Other, format!("JNI set_region: {}", e)))?;
        ...
        .map_err(|e| io::Error::new(io::ErrorKind::Other, format!("JNI write: {}", e)))?;
